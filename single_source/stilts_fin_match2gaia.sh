...
stilts cdsskymatch cdstable=I/355/gaiadr3 \
 ...
 ocmd='delcols "ra_error dec_error healpix raObs decObs obsEp 2000Ep" '\
...
stilts tpipe in=gaia_pm_match.fits ifmt=fits  out=tmp_gaia_pm_match.fits ofmt=fits \
 cmd='delcols "designation source_id ra2016gaia dec2016gaia parallax pm_in pmra_in pmra_error pmdec pmdec_error phot_g_mean_mag bp_rp bp_g g_rp non_single_star"' \
